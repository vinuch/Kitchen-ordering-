      ...
      <div className="mx-auto max-w-md rounded-xl bg-white p-5 shadow-sm">
        ...
        <form action={`/api/staff-invites/${token}/accept`} method="POST" className="mt-5 space-y-4">
          <div>
            ...
            <input name="name" required className="mt-1 w-full rounded border border-gray-300 px-3 py-2 text-black placeholder-gray-400" placeholder="Your name" />
          </div>

          <div>
            <label className="block text-sm font-semibold text-black">4-digit PIN</label>
            <input name="pin" required minLength={4} maxLength={4} inputMode="numeric" className="mt-1 w-full rounded border border-gray-300 px-3 py-2 text-black placeholder-gray-400" placeholder="1234" />
          </div>
